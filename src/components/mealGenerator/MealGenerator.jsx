    ...
    render() {
        ...
        return (
          <React.Fragment>
            ...
            >
              <svg className="mt-5 h1" stroke="currentColor" fill="currentColor" strokeWidth="0" version="1" viewBox="0 0 48 48" enableBackground="new 0 0 48 48" height="1em" width="1em">
                <g fill="#616161">
